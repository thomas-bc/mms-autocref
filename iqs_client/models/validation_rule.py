...
class ValidationRule(object):
    ...
    openapi_types = {
        ...
        'severity': 'str',
        'message': 'str',
        'matching_elements': 'list[TypedElementDescriptor]'
    }
    ...
    @property
    def message(self):
        """Gets the message of this ValidationRule.  # noqa: E501


        :return: The message of this ValidationRule.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this ValidationRule.


        :param message: The message of this ValidationRule.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    def matching_elements(self):
        ...
        :rtype: list[TypedElementDescriptor]
        """
    ...
    def matching_elements(self, matching_elements):
        ...
        :type: list[TypedElementDescriptor]
        """
